    ...
    const featureData = {
      welcome: {
        ...
        description: `
          ...
          <p>Research from the Society for Human Resource Management shows that <span class="stat-highlight">69% of employees</span> are more likely to stay with a company for three years if they experienced great onboarding.</p>
      ...
      service: {
        ...
        description: `
          ...
          <h4>The Retention Crisis</h4>
                      <p>With the average cost of replacing an employee reaching <span class="stat-highlight">$15,000</span> according to the Center for American Progress, retaining experienced team members is crucial.</p>
